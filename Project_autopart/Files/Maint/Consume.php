...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($PartNo_err) && empty($Qty_err)){
        ...
        $sql = "INSERT INTO Transaction (EID, PartNo, Qty, Date) VALUES (?, ?, -?, now())";
				...
				if($stmt = mysqli_prepare($link, $sql_update)){
						...
						if(mysqli_stmt_execute($stmt)){
							...
							if($stmt = mysqli_prepare($link, $sql)){
								...
								echo "Insufficient consuming, Check number of quantity on hand.";
						}
					} else{
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Consuming Part</h2>
                    </div>
                    <p>Please fill this form and submit to consume part.</p>
